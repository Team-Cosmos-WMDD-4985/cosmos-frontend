      ...
      <View style={styles.content}>
        ...
        <View>
          ...
          <View style={styles.datePickerRow}>
            <TouchableOpacity
              onPress={() => setShowStartDatePicker(Platform.OS === "ios")}
            >
              {startDate != null ? (
                <Text style={styles.label}>{startDate.toDateString()}</Text>
              ) : (
            ...
            />
            <TouchableOpacity
              onPress={() => setShowEndDatePicker(Platform.OS === "ios")}
            >
              {endDate != null ? (
                <Text style={styles.label}>{endDate.toDateString()}</Text>
              ) : (
