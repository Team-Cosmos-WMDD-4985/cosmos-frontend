...
const Feature1 = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>via our Management System</Text>
      ...
      <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('Feature2')}>
